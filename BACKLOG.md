...
with real action menus. Upper floors shipped same day. Combat/thieving/fishing/prayer/search
SHIPPED 2026-07-07 (sourced formulas + tables; see combat.js + GAME_KB). Remaining under
[client:simulation]: dialogue scripts, shop stock/prices, drop tables, gear bonuses, NPC
movement AI — each needs a sourced dataset.
